...
// import { Button, Checkbox, InputNumber, Table, Tooltip, Radio, Spin, Modal, Input } from 'antd'
...
//   const [csvwidth, setcsvwidth] = useState('90px')
...
//       axios
//         .put(`https://www.troes.io/suspend_user.php?user_id=${id}`)
//         .then((res) => console.log(res, 're'))
//         .catch((err) => console.log(err))
...
//       }
//      await fetch(`${troesAPi}/importcustomer`, {
//         method: 'POST',
//         mode: 'no-cors',
...
//         // console.log(res.data[0].pwa_name,' - ',res.data[0].pwa_email,' - ',res.data[0].device_id,' - ',res.data[0].daily_uses,'- end')
//       })
//       .catch((err) => {
//         console.log(err)
//       })
...
//               className="csv_box"
//             >
//               <form onSubmit={handleSubmit} style={{ display: 'flex' }} className="csv_form">
//                 <input
//                   ref={inputRef}
//                   type="file"
...
//               <div className="forChanging_color" style={{ background: 'pink' }}></div>
//               <button
...
//             </div>
//             <div className="forAlignment_Account">
//               <div className="forChanging_color" style={{ background: '#0081a7' }}></div>
//               <button
//                 className="btn_for_Link"
...
//                     </Radio.Group>
//                   </div>
//                   <span className="plan__uncheck_one" onClick={statuscut}>
//                     <CloseOutlined />
//                   </span>
//                 </div>
//               ) : (
...
//                               <img src={noDeviceId} alt="" style={{ width: '22px' }} />
//                             </span>
...
//                               {/* <FlagTwoTone /> */}
//                               <img src={partialMatched} alt="" style={{ width: '20px' }} />
//                             </span>
...
//                     Zipcode
//                   </label>
//                   <input type="text" style={{ width: '100px' }} value={newZipcode} readOnly />
//                 </div>
//                 <div className="part_2">
//                   <label htmlFor="State" style={{ fontWeight: '600' }}>
//                     State
//                   </label>
//                   <input type="text" style={{ width: '100px' }} value={newState} readOnly />
//                 </div>
//               </div>
//               <div
//                 style={{
...
//                 }}
//               >
//                 <button className="btn2" required onChange={finalCall}>
//                   Create User
//                 </button>
//                 <button className="btn_cancel" onClick={empty}>
//                   Cancel
//                 </button>
//               </div>
//             </form>
...
//               Export Report
//             </Button>,
//             <Button key="back" onClick={handleC}>
//               Cancel
//             </Button>,
//             <Button key="" type="primary" loading={loading} onClick={handleO}>
//               OK
//             </Button>,
//           ]}
//         >
...
//               <th style={{textAlign:'center'}}>Current Device ID</th>
//               <th>Total Usage</th>
...
//                     <tr key={ind}>
//                     <td style={{textAlign:'center'}}> {item.pwa_name}</td>
//                       <td> {item.device_id}</td>
//                       <td> {item.daily_uses}</td>
//                     </tr>
...
import { Button, Checkbox, InputNumber, Table, Tooltip, Radio, Spin, Modal, Input,message, Upload } from 'antd'
import { notification } from 'antd'
import FrameOne from '../../assets/images/FrameOne.svg'
import Frame from '../../assets/images/Frame.svg'
import FrameTwo from '../../assets/images/FrameTwo.svg'
  ...
  const content = (item) => {
    return (
      <div style={{ display: 'flex', gap: '20px', alignItems: 'center' }}>
        ...
        {item?.pwa_status == 1 || item.pwa_status == 5 || item.pwa_status == 4 && item.pause_resume == 0 ? (
          <Tooltip title="Pause">
            <button
              style={{ border: 'none', backgroundColor: '#fff', width:'15px' }}
  ...
  return (
      ...
      <div className="container-fluid customer_information" style={{ position: 'relative' }}>
        ...
        <div className="search_heading" style={{ position: 'relative' }}>
          ...
          <div className='searchplaceholder'>
            ...
            <div className="uI_hndle" style={{ marginTop: '-13px' }}>
              {/* <Button id="handle__addFilter" type="primary" onClick={handleClicked}> */}
              <Button
              ...
              {clearData ? (
                <Button id="clearbutton" className="for_Filter_Clear" onClick={() => clearFiltererd()}>
                  <ClearOutlined
                    style={{
                      fontSize: '20px',
                      fontWeight: 'bolder',
    ...
    <Button icon={<UploadOutlined />}  onChange={handleFileChange}  className="w-55 input_type_file"
          ...
          <div className="filter__Active">
            ...
            <div className="forAlignment_Account">
              <div className="forChanging_color" style={{ background: '#5A5A5A' }}></div>
              <button
                className="btn_for_Link"
...
<div className='add_filter1wrap'>
              ...
              {priceData ? (
                <div className="price__div">
                  ...
                  <InputNumber
                    ...
                    defaultValue={0}
                    onChange={onChangeed}
                    style={{ marginLeft: '58px', width: '120px' }}
                  />
                </div>
              ) : (
                ''
          ...
          <table className="table table-hover">
            <thead style={{ color: '#fff' }}>
              <tr>
                    ...
                    >
                      ...
                      >
                        {sortingState['Device_Id'] === 'ASC' ? (
                          <ArrowUpOutlined style={{ color: '#918d8d',paddingTop:'1px', paddingLeft:'5px'  }} />
                        ) : (
                          <ArrowDownOutlined style={{ color: '#918d8d',paddingTop:'1px', paddingLeft:'5px'  }} />
                        )}
                      </span>
                    </div>
                  </Tooltip>
                    ...
                    >
                      ...
                      >
                        {sortingState['Unique_Id'] === 'ASC' ? (
                          ...
                          <ArrowDownOutlined style={{ color: '#918d8d',paddingTop:'3px',paddingLeft:'5px' }} />
                        )}
                      </span>
                    </div>
                  </Tooltip>
                ...
                <th onClick={() => sorting('pwa_name')} scope="col" className='global_th text-center'>
                  <Tooltip title="Click To Sort">
                    <div
      ...
      <Modal
        ...
        footer={[
          ...
          <Button style={{borderRadius:'9px'}} key="" type="primary" loading={loading} onClick={handleO}>
            OK
          </Button>,
        ]}
      >
      ...
      <Pagination
        ...
        onShowSizeChange={onShowSizeChange}
        itemRender={itemRender}
        style={{ paddingLeft: '12px',marginTop:"10px", display: 'flex', justifyContent: 'flex-start' }}
      />
    </>
  )
}
