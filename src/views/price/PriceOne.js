          ...
          <form onSubmit={signUp}>
            ...
            <div id="add__Item">
              ...
              <div className="total_pr_local">
                <p className="functioned_p" onClick={totalPrice}>
                  Check Total Price
                </p>
                    ...
                    <div className="for_box_shadow">
                      <div className="middle_div">
                        ...
                        <div className="middle__price__one">
                          ...
                          <p className="price_comb_sales">Sales Tax: {item.salesTax}%</p>
                        </div>

                        <hr style={{ width: '95%', margin: 'auto' }} />
                        <div className="bottom__toTal">
                          <p className="mont_Total">Total: ${item.totalSalexTax} /month</p>
                        </div>
                      </div>
                    </div>
